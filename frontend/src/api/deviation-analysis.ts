...
export const submitPhaseReview = (id: number, phase: string, decision: PhaseDecision, comment: string) =>
  api<DeviationAnalysis>(`/deviation-analyses/${id}/phase-reviews`, json('POST', { phase, decision, comment }))
